...
import com.timwe.tti2sdk.data.entity.Position
...
//        )
    ...
    private fun findIndex(positions: ArrayList<Position>, xValue: Float, yValue: Float): Int{
        val tolerancia = 20f
    ...
    private fun mapPosition() : ArrayList<Position>{
